        ...
        "
          >
            <div class="mobile-lg:grid-col-auto">
              <img
                class="usa-footer__logo-img" src="assets\img\logo-img.png" alt="" />
            </div>
          ...
          <div class="usa-footer__contact-links mobile-lg:grid-col-6">
            <div class="usa-footer__social-links grid-row grid-gap-1">
              ...
              <div class="grid-col-auto">
                <a class="usa-social-link" href="javascript:void(0);">
                <svg class="usa-social-link__icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><circle cx="6.18" cy="17.82" r="2.18"/><path d="M4 4.44v2.83c7.03 0 12.73 5.7 12.73 12.73h2.83c0-8.59-6.97-15.56-15.56-15.56zm0 5.66v2.83c3.9 0 7.07 3.17 7.07 7.07h2.83c0-5.47-4.43-9.9-9.9-9.9z"/></svg>
                </a>
              </div>
